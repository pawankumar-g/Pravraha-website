...
export default function Footer() {
  return (
    <footer className="bg-gray-50 mt-12">
      {/* Main Footer */}
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div className="lg:col-span-2">
          ...
          <p className="text-gray-600 max-w-md leading-relaxed mb-6">
            High Quality by Definition, Excellence by Execution. We help
            companies accelerate growth through data-driven marketing and
